...
<div class="container mt-5 centrar-texto" style="higth: 100rem;">
    <h1 class="centrar-texto pb-2 pt-3">Lista de Productos</h1>
            <div class="col-md-12 ">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <th><a href="<?php echo base_url('muestra-editar-producto/'.$id);?>" class="btn btn-info">Editar</a>
                                        <a href="<?php echo base_url('bajar-producto/'.$id);?>" class="btn btn-danger">Baja</a></th>                                        
                                    </tr>
                                <?php 
                                        }
                                     }
